...
export function getDeliveryState(result: Pick<AirlockMediatorResult, "triage_level" |
"needs_human_review">): AirlockDeliveryState {
...
export function canDeliverMessage(result: Pick<AirlockMediatorResult, "triage_level" |
"needs_human_review">) {
   return getDeliveryState(result) !== "paused_for_review";
}

export function shouldOfferReframe(result: Pick<AirlockMediatorResult, "triage_level" |
"needs_human_review" | "reframed_message">) {
   if (result.needs_human_review || result.triage_level === "red") {
       return false;
   }
...
export function requiresSenderChoice(result: Pick<AirlockMediatorResult, "triage_level" |
"needs_human_review" | "reframed_message">) {
...
export function getSenderHoldingMessage(result: Pick<AirlockMediatorResult, "triage_level" |
"needs_human_review">) {
   if (result.needs_human_review || result.triage_level === "red") {
...
export function getReceiverHoldingMessage(result: Pick<AirlockMediatorResult, "triage_level" |
"needs_human_review">) {
   if (result.needs_human_review || result.triage_level === "red") {
